...
>
	<div class="flex flex-col items-center gap-2">
		...
		<button
			...
			{disabled}
			class="touch-target inline-flex items-center justify-center mt-1 px-4 py-1.5 text-xs font-medium text-white bg-teal-700 rounded-lg hover:bg-teal-800 disabled:opacity-50 disabled:cursor-not-allowed transition-colors cursor-pointer"
		>
			Göz at
		</button>
		<input

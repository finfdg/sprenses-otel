...
<aside class="fixed inset-y-0 left-0 z-40 w-60 transform transition-transform duration-300 ease-in-out {sidebar.open ? 'translate-x-0' : '-translate-x-full'} md:relative md:translate-x-0 md:z-auto md:transition-all md:duration-300 {collapsed ? 'md:w-16' : 'md:w-60'} bg-white border-r border-gray-200 flex flex-col h-full shrink-0">
	...
	<nav class="flex-1 overflow-y-auto py-3 px-2 space-y-1">
		...
		{#if hasPerm('quality.templates') || hasPerm('quality.forms')}
			...
			>
				<span class="flex items-center gap-3">
					<svg class="w-5 h-5 shrink-0 {isGroupActive('/dashboard/kalite') ? 'text-teal-600' : 'text-gray-500'}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
				...
				<svg class="w-4 h-4 text-gray-500 transition-transform {expandedGroups.quality ? 'rotate-180' : ''} {collapsed ? 'md:hidden' : ''}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
			...
			{#if expandedGroups.quality && !collapsed}
				<div class="ml-4 space-y-0.5">
					{#if hasPerm('quality.templates')}
						...
						>
							<svg class="w-4 h-4 shrink-0 {isActive('/dashboard/kalite/sablonlar') ? 'text-teal-600' : 'text-gray-500'}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
					...
					{#if hasPerm('quality.forms')}
						...
						>
							<svg class="w-4 h-4 shrink-0 {isGroupActive('/dashboard/kalite/formlar') ? 'text-teal-600' : 'text-gray-500'}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
		...
		{#if hasPerm('finance.cash_flow') || hasPerm('finance.banks') || hasPerm('finance.doviz') || hasPerm('finance.cariler') || hasPerm('finance.checks')}
			...
			>
				<span class="flex items-center gap-3">
					<svg class="w-5 h-5 shrink-0 {isGroupActive('/dashboard/finans') ? 'text-teal-600' : 'text-gray-500'}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
				...
				<svg class="w-4 h-4 text-gray-500 transition-transform {expandedGroups.finance ? 'rotate-180' : ''} {collapsed ? 'md:hidden' : ''}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
					<path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7" />
				</svg>
			</button>
			...
			{#if expandedGroups.finance && !collapsed}
				<div class="ml-4 space-y-0.5">
					{#if hasPerm('finance.cash_flow')}
						...
						>
							<svg class="w-4 h-4 shrink-0 {isActive('/dashboard/finans/nakit-akim') ? 'text-teal-600' : 'text-gray-500'}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
					...
					{#if hasPerm('finance.banks')}
						...
						>
							<svg class="w-4 h-4 shrink-0 {isActive('/dashboard/finans/bankalar') && !isActive('/dashboard/finans/bankalar/talimatlar') ? 'text-teal-600' : 'text-gray-500'}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
						...
						>
							<svg class="w-4 h-4 shrink-0 {isActive('/dashboard/finans/bankalar/talimatlar') ? 'text-teal-600' : 'text-gray-500'}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
								<path stroke-linecap="round" stroke-linejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" />
							</svg>
							Talimatlar
						</a>
					...
					{#if hasPerm('finance.doviz')}
						...
						>
							<svg class="w-4 h-4 shrink-0 {isActive('/dashboard/finans/doviz') ? 'text-teal-600' : 'text-gray-500'}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
					...
					{#if hasPerm('finance.cariler')}
						...
						>
							<svg class="w-4 h-4 shrink-0 {isActive('/dashboard/finans/cariler') ? 'text-teal-600' : 'text-gray-500'}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
					...
					{#if hasPerm('finance.checks')}
						...
						>
							<svg class="w-4 h-4 shrink-0 {isActive('/dashboard/finans/cekler') ? 'text-teal-600' : 'text-gray-500'}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
					...
					{#if hasPerm('finance.krediler')}
						...
						>
							<svg class="w-4 h-4 shrink-0 {isActive('/dashboard/finans/krediler') ? 'text-teal-600' : 'text-gray-500'}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
					...
					{#if hasPerm('finance.avanslar')}
						...
						>
							<svg class="w-4 h-4 shrink-0 {isActive('/dashboard/finans/avanslar') ? 'text-teal-600' : 'text-gray-500'}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
								<path stroke-linecap="round" stroke-linejoin="round" d="M2.25 18.75a60.07 60.07 0 0115.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 013 6h-.75m0 0v-.375c0-.621.504-1.125 1.125-1.125H20.25M2.25 6v9m18-10.5v.75c0 .414.336.75.75.75h.75m-1.5-1.5h.375c.621 0 1.125.504 1.125 1.125v9.75c0 .621-.504 1.125-1.125 1.125h-.375m1.5-1.5H21a.75.75 0 00-.75.75v.75m0 0H3.75m0 0h-.375a1.125 1.125 0 01-1.125-1.125V15m1.5 1.5v-.75A.75.75 0 003 15h-.75M15 10.5a3 3 0 11-6 0 3 3 0 016 0zm3 0h.008v.008H18V10.5zm-12 0h.008v.008H6V10.5z" />
							</svg>
							Alınan Avanslar
						</a>
					...
					{#if hasPerm('finance.butce')}
						...
						>
							<svg class="w-4 h-4 shrink-0 {isActive('/dashboard/finans/butce') ? 'text-teal-600' : 'text-gray-500'}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
					...
					{#if hasPerm('finance.onay')}
						...
						>
							<svg class="w-4 h-4 shrink-0 {isActive('/dashboard/finans/onay') ? 'text-teal-600' : 'text-gray-500'}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
		...
		{#if hasPerm('accounting.taxes') || hasPerm('accounting.recurring') || hasPerm('accounting.rent_income') || hasPerm('accounting.rent_expense') || hasPerm('accounting.dividend')}
			...
			>
				<span class="flex items-center gap-3">
					<svg class="w-5 h-5 shrink-0 {isGroupActive('/dashboard/muhasebe') ? 'text-teal-600' : 'text-gray-500'}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
				...
				<svg class="w-4 h-4 text-gray-500 transition-transform {expandedGroups.accounting ? 'rotate-180' : ''} {collapsed ? 'md:hidden' : ''}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
					<path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7" />
				</svg>
			</button>
			...
			{#if expandedGroups.accounting && !collapsed}
				<div class="ml-4 space-y-0.5">
					{#if hasPerm('accounting.taxes')}
						...
						>
							<svg class="w-4 h-4 shrink-0 {isActive('/dashboard/muhasebe/vergiler') ? 'text-teal-600' : 'text-gray-500'}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
					...
					{#if hasPerm('accounting.recurring')}
						...
						>
							<svg class="w-4 h-4 shrink-0 {isActive('/dashboard/muhasebe/duzenli-odemeler') ? 'text-teal-600' : 'text-gray-500'}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
					...
					{#if hasPerm('accounting.rent_income')}
						...
						>
							<svg class="w-4 h-4 shrink-0 {isActive('/dashboard/muhasebe/alinan-kiralar') ? 'text-teal-600' : 'text-gray-500'}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
								<path stroke-linecap="round" stroke-linejoin="round" d="M2.25 12l8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" />
							</svg>
							Alınan Kiralar
						</a>
					...
					{#if hasPerm('accounting.rent_expense')}
						...
						>
							<svg class="w-4 h-4 shrink-0 {isActive('/dashboard/muhasebe/verilen-kiralar') ? 'text-teal-600' : 'text-gray-500'}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
					...
					{#if hasPerm('accounting.dividend')}
						...
						>
							<svg class="w-4 h-4 shrink-0 {isActive('/dashboard/muhasebe/temettu') ? 'text-teal-600' : 'text-gray-500'}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
								<path stroke-linecap="round" stroke-linejoin="round" d="M12 6v12m-3-2.818l.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 12.219 12.768 12 12 12c-.725 0-1.45-.22-2.003-.659-1.106-.879-1.106-2.303 0-3.182s2.9-.879 4.006 0l.415.33M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
							</svg>
							Temettü
						</a>
		...
		{#if hasPerm('hr.salary') || hasPerm('hr.withholding') || hasPerm('hr.sgk')}
			...
			>
				<span class="flex items-center gap-3">
					<svg class="w-5 h-5 shrink-0 {isGroupActive('/dashboard/ik') ? 'text-teal-600' : 'text-gray-500'}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
				...
				<svg class="w-4 h-4 text-gray-500 transition-transform {expandedGroups.hr ? 'rotate-180' : ''} {collapsed ? 'md:hidden' : ''}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
					<path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7" />
				</svg>
			</button>
			...
			{#if expandedGroups.hr && !collapsed}
				<div class="ml-4 space-y-0.5">
					{#if hasPerm('hr.salary')}
						...
						>
							<svg class="w-4 h-4 shrink-0 {isActive('/dashboard/ik/maas') ? 'text-teal-600' : 'text-gray-500'}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
								<path stroke-linecap="round" stroke-linejoin="round" d="M2.25 18.75a60.07 60.07 0 0115.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 013 6h-.75m0 0v-.375c0-.621.504-1.125 1.125-1.125H20.25M2.25 6v9m18-10.5v.75c0 .414.336.75.75.75h.75m-1.5-1.5h.375c.621 0 1.125.504 1.125 1.125v9.75c0 .621-.504 1.125-1.125 1.125h-.375m1.5-1.5H21a.75.75 0 00-.75.75v.75m0 0H3.75m0 0h-.375a1.125 1.125 0 01-1.125-1.125V15m1.5 1.5v-.75A.75.75 0 003 15h-.75M15 10.5a3 3 0 11-6 0 3 3 0 016 0zm3 0h.008v.008H18V10.5zm-12 0h.008v.008H6V10.5z" />
							</svg>
							Maaş
						</a>
					...
					{#if hasPerm('hr.withholding')}
						...
						>
							<svg class="w-4 h-4 shrink-0 {isActive('/dashboard/ik/stopaj') ? 'text-teal-600' : 'text-gray-500'}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
								<path stroke-linecap="round" stroke-linejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" />
							</svg>
							Stopaj
						</a>
					...
					{#if hasPerm('hr.sgk')}
						...
						>
							<svg class="w-4 h-4 shrink-0 {isActive('/dashboard/ik/sgk') ? 'text-teal-600' : 'text-gray-500'}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
		...
		{#if hasPerm('sales.flight') || hasPerm('sales.hotel_reservation') || hasPerm('sales.room_types')}
			...
			>
				<span class="flex items-center gap-3">
					<svg class="w-5 h-5 shrink-0 {isGroupActive('/dashboard/satis') ? 'text-teal-600' : 'text-gray-500'}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
						<path stroke-linecap="round" stroke-linejoin="round" d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 00-3 3h15.75m-12.75-3h11.218c1.121-2.3 2.1-4.684 2.924-7.138a60.114 60.114 0 00-16.536-1.84M7.5 14.25L5.106 5.272M6 20.25a.75.75 0 11-1.5 0 .75.75 0 011.5 0zm12.75 0a.75.75 0 11-1.5 0 .75.75 0 011.5 0z" />
					</svg>
					<span class="{collapsed ? 'md:hidden' : ''} font-medium">Satış</span>
				</span>
				<svg class="w-4 h-4 text-gray-500 transition-transform {expandedGroups.sales ? 'rotate-180' : ''} {collapsed ? 'md:hidden' : ''}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
					<path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7" />
				</svg>
			</button>
			...
			{#if expandedGroups.sales && !collapsed}
				<div class="ml-4 space-y-0.5">
					{#if hasPerm('sales.hotel_reservation')}
						...
						>
							<svg class="w-4 h-4 shrink-0 {isActive('/dashboard/satis/otel-rezervasyon') ? 'text-teal-600' : 'text-gray-500'}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
								<path stroke-linecap="round" stroke-linejoin="round" d="M2.25 12l8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" />
							</svg>
							Otel Rezervasyon
						</a>
					...
					{#if hasPerm('sales.room_types')}
						...
						>
							<svg class="w-4 h-4 shrink-0 {isActive('/dashboard/satis/oda-tipleri') ? 'text-teal-600' : 'text-gray-500'}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
					...
					{#if hasPerm('sales.flight')}
						...
						>
							<svg class="w-4 h-4 shrink-0 {isActive('/dashboard/satis/ucak-rezervasyon') ? 'text-teal-600' : 'text-gray-500'}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
		...
		{#if hasPerm('system.users') || hasPerm('system.roles') || hasPerm('system.modules') || hasPerm('system.audit_logs') || hasPerm('system.error_logs') || hasPerm('system.approval')}
			...
			>
				<span class="flex items-center gap-3">
					<svg class="w-5 h-5 shrink-0 {isGroupActive('/dashboard/sistem') ? 'text-teal-600' : 'text-gray-500'}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
				...
				<svg class="w-4 h-4 text-gray-500 transition-transform {expandedGroups.system ? 'rotate-180' : ''} {collapsed ? 'md:hidden' : ''}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
					<path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7" />
				</svg>
			</button>
			...
			{#if expandedGroups.system && !collapsed}
				<div class="ml-4 space-y-0.5">
					{#if hasPerm('system.users')}
						...
						>
							<svg class="w-4 h-4 shrink-0 {isActive('/dashboard/sistem/kullanicilar') ? 'text-teal-600' : 'text-gray-500'}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
					...
					{#if hasPerm('system.roles')}
						...
						>
							<svg class="w-4 h-4 shrink-0 {isActive('/dashboard/sistem/roller') ? 'text-teal-600' : 'text-gray-500'}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
								<path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75L11.25 15 15 9.75m-3-7.036A11.959 11.959 0 013.598 6 11.99 11.99 0 003 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285z" />
							</svg>
							Roller
						</a>
					...
					{#if hasPerm('system.modules')}
						...
						>
							<svg class="w-4 h-4 shrink-0 {isActive('/dashboard/sistem/moduller') ? 'text-teal-600' : 'text-gray-500'}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
					...
					{#if hasPerm('system.audit_logs')}
						...
						>
							<svg class="w-4 h-4 shrink-0 {isActive('/dashboard/sistem/audit-loglar') ? 'text-teal-600' : 'text-gray-500'}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
								<path stroke-linecap="round" stroke-linejoin="round" d="M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 002.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 00-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 00.75-.75 2.25 2.25 0 00-.1-.664m-5.8 0A2.251 2.251 0 0113.5 2.25H15c1.012 0 1.867.668 2.15 1.586m-5.8 0c-.376.023-.75.05-1.124.08C9.095 4.01 8.25 4.973 8.25 6.108V8.25m0 0H4.875c-.621 0-1.125.504-1.125 1.125v11.25c0 .621.504 1.125 1.125 1.125h9.75c.621 0 1.125-.504 1.125-1.125V9.375c0-.621-.504-1.125-1.125-1.125H8.25zM6.75 12h.008v.008H6.75V12zm0 3h.008v.008H6.75V15zm0 3h.008v.008H6.75V18z" />
							</svg>
							Audit Logları
						</a>
					...
					{#if hasPerm('system.error_logs')}
						...
						>
							<svg class="w-4 h-4 shrink-0 {isActive('/dashboard/sistem/hata-loglar') ? 'text-teal-600' : 'text-gray-500'}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
					...
					{#if hasPerm('system.approval')}
						...
						>
							<svg class="w-4 h-4 shrink-0 {isActive('/dashboard/sistem/onay-akisi') ? 'text-teal-600' : 'text-gray-500'}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
					...
					{#if hasPerm('system.server')}
						...
						>
							<svg class="w-4 h-4 shrink-0 {isActive('/dashboard/sistem/sunucu') ? 'text-teal-600' : 'text-gray-500'}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">

...
<div class="{selectedConvId ? 'hidden md:flex' : 'flex'} w-full md:w-80 border-r border-gray-200 flex-col shrink-0 bg-white">
	<div class="px-4 py-3 border-b border-gray-200 flex items-center justify-between">
		...
		<button onclick={onNewChat} class="w-8 h-8 rounded-full bg-teal-600 text-white flex items-center justify-center hover:bg-teal-700 transition-colors cursor-pointer" title="Yeni Mesaj">

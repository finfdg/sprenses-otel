...
| Alan | Değer |
|---|---|
| **Modül kodu** | `sales.room_types` |
| **Üst modül** | `sales` (Satış) |
| **Frontend rota** | `/dashboard/satis/oda-tipleri` |
...
| Dosya | Açıklama |
|---|---|
| `frontend/src/routes/dashboard/satis/oda-tipleri/+page.svelte` | CRUD sayfası — tablo + modal + canlı toplam doğrulama |

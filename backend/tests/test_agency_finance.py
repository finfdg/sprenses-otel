...
class TestAgencyFinanceMath:
    ...
    def test_monthly_sources_and_receivable_plan(self, db):
        ...
        # 1 Nisan fatura +30 gün = 1 Mayıs; 200€ tahsil sonrası 300€ açık ve gecikmiş.
        assert months[5]["open_due"] == 300
        assert months[5]["overdue"] == 300
        assert months[5]["month_end_receivable"] == 300
        ...
        # Ağustos çıkışlı 1.000€ rezervasyon Eylül vadesine taşınır; kalan 200€ avans FIFO mahsup.
        assert months[9]["projected_gross"] == 1000
        assert months[9]["projected_advance"] == 200
        assert months[9]["projected_due"] == 800
